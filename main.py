...
if __name__ == '__main__':
    ...
    if eta > xDelta and eta > yDelta:
        ...
        inletPressure = 1.0
        u, v, pressure, tau = initFlowParams(xNums, yNums, density, viscosity, inletVelocities, inletPressure, device)

        u, v, pressure = fvmSolver(scheme, u, v, pressure, tau, xNums, yNums, xDelta, yDelta, device)
    else:
